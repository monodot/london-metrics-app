...
A Java project that uses Apache Camel to fetch and publish city metrics to a Graphite instance, for displaying on a Grafana dashboard.
...
You can then execute your native executable with: `./target/london-metrics-app-1.0.0-SNAPSHOT-runner`
